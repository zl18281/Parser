...
int main(int argc, char** argv)
{
   ...
   Neill_SDL_Init(&sw);
   Neill_SDL_SetDrawColour(&sw, (SDL_8BITCOLOUR - 1), 0, 0); /*red, green, blue*/
   if(argc != 2){
      fprintf(stderr, "Argument number for %s not right", argv[0]);
      exit(2);
   }
   ...
   /*Scan a turtle program into "program" structure word by word and point the "tail" at the last word*/
   i = 0;
