...
void test_strategy(void)
{
   ...
   /*Test of function "search_table_value" (White Box)*/
   {
      ...
      /*search_table_value(&t, "X");*/
      printf("Test of function \"search_table_value\" succeeded !\n");
   }
   ...
   /*Tests of function "is_instruction", "is_instruction_list", "is_main" are conducted in parser (White Box)*/
   /*Test of function "is_do" is via printing symbol table (thus iterator) and turtle instructions conducted*/
   {
      printf("Function \"is_instruction\", \"is_instruction_list\", \"is_main\" are tested in parser\n");
      printf("See printed information about testing of function \"is_do\"\n");
   }
